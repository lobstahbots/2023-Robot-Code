  ...
  public ArmTowardsPoseWithRetractionCommand(Arm arm, ArmPose pose) {
    ...
    addCommands(
        ...
        new ArmToPoseCommand(
            ...
            ArmConstants.BUMPER_AVOIDANCE_ANGLE_PRECISION, 0)
                .unless(() -> !arm.getPose()
                    .isInsideBumperZone()),
        ...
        new ArmToPoseCommand(
            ...
            0, ArmConstants.BUMPER_AVOIDANCE_EXTENSION_PRECISION),
        ...
        new SequentialCommandGroup(
            ...
            new ArmToPoseCommand(arm, () -> ArmPose.fromAngleExtension( //
                ...
                0, ArmConstants.BUMPER_AVOIDANCE_EXTENSION_PRECISION)).unless(() -> !pose.isInsideBumperZone()),
